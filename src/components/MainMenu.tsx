...
const platforms: MenuItem[] = [
  ...
  {
    label: "EmailBison - Power-Driven Email Automation",
    value: "emailbison",
    description: "Advanced automation with power levels 1-10",
    commands: 32,
    icon: "🦬",
    color: "yellow",
  },
  {
    ...
    value: "amplemarket",
    description: "AI-powered B2B intelligence platform",
    commands: 15,
    icon: "📊",
    color: "blue",
  },
  {
    ...
    value: "outreach",
    description: "Enterprise-grade sales automation",
    commands: 55,
    icon: "🎯",
    color: "purple",
  },
  ...
  },
  {
    ...
    value: "lemlist",
    description: "Creative personalized cold email automation",
    commands: 25,
    icon: "🎨",
    color: "pink",
  },
